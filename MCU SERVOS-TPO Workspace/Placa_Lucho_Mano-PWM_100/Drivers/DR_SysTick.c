...
//	LCD_Driver();
//	// Para la inicialización del LCD:
//	if (LCD_delay){
//		LCD_delay--;
//	}

	// DRIVERS TECLADOS - anti-rebote
	DriverSwitches();
...
//		switch( f_Stop_Suave ){
//		case EXPONENCIAL:
//			Tick_Call_Back_Stop_Suave_Exponencial();
//			break;
//		case LINEAL:
//			Tick_Call_Back_Stop_Suave_Lineal();
//			break;
//		case ELIPTICO:
//			Tick_Call_Back_Stop_Suave_Eliptico();
//			break;
//		default:
//			Tick_Call_Back_Stop_Suave_Lineal();
//			break;
