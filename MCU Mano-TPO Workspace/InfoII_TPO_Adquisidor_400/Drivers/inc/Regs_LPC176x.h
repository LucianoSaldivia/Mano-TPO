...
// Los registros del SysTick son direcciones consecutivas ( LPC1769 )
#define STCTRL		SysTick[0]
#define	STRELOAD	SysTick[1]
#define STCURR		SysTick[2]
#define STCLAIB		SysTick[3]


/********************************************/
/* Registros del SYSTICK con CAMPOS DE BITS */
/********************************************/
...
// FALTABA:
#define		T0CTCR		( ( registro * ) 0x40004070UL )
...
#define		U0FDR		( ( registro * ) 0x4000C028UL )
...
// Agregado por mí
#define		U1FDR		( ( registro * ) 0x40010028UL )
